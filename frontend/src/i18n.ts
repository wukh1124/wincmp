...
export const enTranslations: Record<string, string> = {
  ...
  "掃描中...": "Scanning...",
  "掃描完成": "Scan Complete",
  "重新掃描 bin/ 目錄下的所有服務二進位檔與版本": "Rescan binary files and versions in bin/ directory",
  ...
  "複製下載連結": "Copy Download Link",
  "已複製下載連結": "Download Link Copied",
  "依賴來源與操作": "Dependency Source & Actions",
  "下載安裝此依賴": "Download & Install This Dependency",
  "更多操作與來源資訊": "More actions & source info",
  "清除錯誤": "Dismiss Error",
  "建議指引與診斷資訊：": "Suggestions and Diagnostic Information:",
  "建議排查指引：": "Troubleshooting Guide:",
  "1. 依賴目錄來源：": "1. Dependency Catalog Source: ",
  "2. 可能原因：官方目錄尚未發布該版本，或本地設定檔缺少安全雜湊值。": "2. Possible Cause: Official catalog has not published this version yet, or local config lacks security hash.",
  "3. 建議操作：請嘗試在右上角點擊「檢查更新」同步最新設定；若為開發測試環境，請確認 conf/dependencies.json 是否已填入正確的 sha256。": "3. Recommended Action: Try clicking 'Check Updates' at top right to sync configs. For development/testing environments, verify conf/dependencies.json has the correct sha256.",
  "1. 遠端配置來源 (DependencyURL)：": "1. Remote Config Source (DependencyURL): ",
  "1. 遠端配置來源：": "1. Remote Config Source: ",
  "2. 請檢查您的網路連線或代理設定後重試。": "2. Check your network connection or proxy settings and retry.",
  "3. 若持續失敗，可手動下載：": "3. If it persists, you can manually download: ",
  "4. 並解壓放置於以下 bin 目錄位置：": "4. And extract it to the following bin directory: ",
  "2. 請先嘗試在右上角點擊「檢查更新」取得最新校驗資訊，然後重試下載。": "2. Try clicking 'Check Updates' at top right to get the latest verification info, then retry downloading.",
  "2. 請先嘗試在依賴管理面板點擊「獲取最新」，然後重試下載。": "2. Try clicking 'Check Updates' in Dependency Manager first, then retry downloading.",
  "3. 若問題持續，請手動下載：": "3. If problem persists, manually download: ",
  "建議指引：": "Suggestions:",
  "檔案可能損毀。請手動下載：": "Archive may be corrupted. Please manually download: ",
  "並解壓放置於以下目錄：": "and extract to the following directory: ",
  "SHA-256 完整性校驗失敗！下載的檔案可能損毀、不完整或遭受中間人篡改。": "SHA-256 integrity verification failed! The downloaded file may be corrupted, incomplete, or tampered with.",
  ...
  "僅 MariaDB 可用": "Available on MariaDB only",
  ...
  "自動檢查版本更新(Github)": "Auto-check version updates (GitHub)",
  "每 6 小時自動檢查，啟動時也會檢查一次": "Check every 6 hours and once on app startup",
  ...
  "複製此行": "Copy this line",
  "全選": "Select all",
  "開啟檔案失敗": "Failed to open file",
  "開啟檔案所在資料夾": "Open Containing Folder",
  "開啟所在資料夾失敗": "Failed to open folder",
  "日誌檔案不存在": "Log file does not exist",
  "Redis 擴充: DLL 已安裝，未在 php.ini 啟用": "Redis extension: DLL installed, not enabled in php.ini",
  "點擊一鍵於 php.ini 啟用 Redis 擴充": "Click to enable Redis extension in php.ini",
  "一鍵啟用 php.ini Redis 擴充": "Enable Redis extension in php.ini",
  "已成功平滑啟用 php.ini 中的 Redis 擴充！若 PHP 已在運行，請重啟 PHP 服務以生效。": "Successfully enabled Redis extension in php.ini! If PHP is running, please restart PHP service to take effect.",
  "啟用失敗": "Failed to enable",
  "Redis 擴充: 已啟用": "Redis Extension: Enabled",
  "Redis 擴充: 未在 php.ini 啟用 (點擊啟用)": "Redis Extension: Not enabled in php.ini (Click to enable)",
  "Redis 擴充: 未安裝 DLL": "Redis Extension: DLL not installed",
  "點擊前往依賴管理器安裝 Redis 擴充 DLL": "Click to open Dependency Manager and install Redis DLL",
  "一鍵啟用": "Enable Now",
  "MariaDB (MySQL)": "MariaDB (MySQL)",
  "Redis (NoSQL)": "Redis (NoSQL)",
  "重新整理 MariaDB 資料庫清單": "Refresh MariaDB databases list",
  "重新整理 Redis 鍵值與連線狀態": "Refresh Redis keys and connection status",
  "Redis 尚未啟動": "Redis is not running",
  "請先前往 儀表板 頁面啟動 Redis 快取服務，再使用快取瀏覽器。": "Please start the Redis service on the Dashboard page before using Cache Explorer.",
  "刪除此鍵": "Delete Key",
  "確定要刪除鍵值 '%s' 嗎？": "Are you sure you want to delete key '%s'?",
  "刪除成功": "Deleted successfully",
  "刪除失敗": "Failed to delete",
  "搜尋鍵名": "Search keys",
  "支援 Redis 萬用字元，例如 cache:*": "Supports Redis globs, e.g. cache:*",
  "載入更多": "Load More",
  "僅顯示部分搜尋結果，可按載入更多": "Partial search results shown. Use Load More for additional keys.",
  "無過期時間": "No Expiry",
  "已過期": "Expired",
  "鍵值內容": "Key Value",
  "資料型態": "Data Type",
  "剩餘 TTL": "TTL Remaining",
  "請從左側選擇一個 Key 以檢視內容": "Please select a key from the left to view contents",
