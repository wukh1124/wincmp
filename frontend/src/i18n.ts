...
export const enTranslations: Record<string, string> = {
  ...
  "清空當前 DB": "Flush Current DB",
  "確定要清空 DB %s 的所有快取鍵值嗎？此操作不可還原！": "Are you sure you want to flush all keys in DB %s? This cannot be undone!",
  "清空成功": "Flushed successfully",
  "清空失敗": "Failed to flush",
  "刪除此鍵": "Delete Key",
  "確定要刪除鍵值 '%s' 嗎？": "Are you sure you want to delete key '%s'?",
  "刪除成功": "Deleted successfully",
  "刪除失敗": "Failed to delete",
  "搜尋鍵名 (例如 laravel_cache:*)...": "Search keys (e.g. laravel_cache:*)...",
  "載入更多": "Load More",
  "無過期時間": "No Expiry",
  "已過期": "Expired",
  "鍵值內容": "Key Value",
