...
var enTranslations = map[string]string{
	...
	"網域 '%s' 格式不正確。僅能包含英數字、連字號(-)與點(.)，且不能包含底線、埠號或路徑。": "Domain '%s' format is incorrect. It can only contain alphanumeric characters, hyphens (-), and dots (.), and cannot contain underscores, ports, or paths.",
